    ...
    <div className="p-4 md:p-8 max-w-[1600px] mx-auto space-y-6">
      <div className="flex justify-between items-center bg-slate-50/80 backdrop-blur-md py-4 border-b border-slate-200">
        <div>
          ...
          <p className="text-slate-500 text-sm font-medium">Record of personnel presence and operational hours.</p>
        </div>
        <button 
      ...
      <div className="grid grid-cols-1 gap-4">
        {(timesheets || []).map(timesheet => (
          <div key={timesheet.id} className="bg-white rounded-2xl border-2 border-slate-200 p-6 flex flex-col md:flex-row md:items-center justify-between gap-6 shadow-sm hover:shadow-md transition-all">
